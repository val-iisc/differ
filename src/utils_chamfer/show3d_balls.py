...
def get2D(xyz, partseg=False, labels=None, ballradius=7, background=(0, 0, 0),
          showsz=400):
...
def get2Dtwopoints(xyz, xyz_pred, c0_pred=green, c1_pred=red, c2_pred=blue,
                   background=(0, 0, 0), ballradius=7, showsz=400):
...
def showpoints_partseg(xyz, labels, c0=None, c1=None, c2=None, waittime=0,
                       showrot=False, magnifyBlue=0, freezerot=False,
                       background=(0, 0, 0), normalizecolor=True,
                       ballradius=10):
...
def showtwopoints(xyz, xyz_pred, c0_pred=green, c1_pred=red, c2_pred=blue,
                  waittime=0, showrot=False, magnifyBlue=0, freezerot=False,
                  background=(0, 0, 0), ballradius=10):
    '''
    Simultaneously display two point clouds.
